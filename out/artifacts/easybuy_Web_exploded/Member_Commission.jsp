...
<div class="m_top_bg">
    <div class="top">
        <div class="m_logo"><a href="Index.jsp"><img src="/statics/images/logo1.png" /></a></div>
        <div class="m_search">
            <form>
	...
	<div class="m_content">
		...
		<div class="m_right">
            ...
            <table border="1" class="co_tab" style="width:930px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="35%"><img src="/statics/images/bag.png" align="absmiddle" /> &nbsp;消费返利</td>
                <td width="65%" style="color:#ff4e00;">100R</td>
              </tr>
              <tr>
                <td width="35%"><img src="/statics/images/bag.png" align="absmiddle" /> &nbsp;预存返还 </td>
                <td width="65%" style="color:#ff4e00;">100R</td>
              </tr>
              <tr>
                <td width="35%"><img src="/statics/images/bag.png" align="absmiddle" /> &nbsp;联盟返利 </td>
                <td width="65%" style="color:#ff4e00;">1000R</td>
              </tr>
              <tr>
                <td width="35%"><img src="/statics/images/bag.png" align="absmiddle" /> &nbsp;可提现余额 </td>
